...
#Core libraries
STM32_USB_C_FILES += $(wildcard $(ST_USB_DEV_BASE)/Core/src/*.c)
...
#Audio
STM32_USB_C_FILES += $(wildcard $(ST_USB_DEV_CLASS_BASE)/audio/src/*.c)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/audio/inc/

#CDC
STM32_USB_C_FILES += $(wildcard $(ST_USB_DEV_CLASS_BASE)/cdc/src/*.c)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/cdc/inc/

#DFU
STM32_USB_C_FILES += $(wildcard $(ST_USB_DEV_CLASS_BASE)/dfu/src/*.c)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/dfu/inc/

#HID
STM32_USB_C_FILES += $(wildcard $(ST_USB_DEV_CLASS_BASE)/hid/src/*.c)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/hid/inc/

#MSC
STM32_USB_C_FILES += $(wildcard $(ST_USB_DEV_CLASS_BASE)/msc/src/*.c)
...
#Core libraries
STM32_USB_C_FILES += $(wildcard $(ST_USB_HOST_BASE)/Core/src/*.c)
...
#HID
STM32_USB_C_FILES += $(wildcard $(ST_USB_HOST_CLASS_BASE)/HID/src/*.c)
LIB_INCLUDES      += -I$(ST_USB_HOST_CLASS_BASE)/HID/inc/

#MSC
STM32_USB_C_FILES += $(wildcard $(ST_USB_HOST_CLASS_BASE)/MSC/src/*.c)
...
STM32_USB_C_FILES += $(wildcard $(ST_USB_OTG_BASE)/src/*.c)
