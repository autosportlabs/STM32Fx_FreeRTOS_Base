...
F0_PERIPH_SOURCES := $(shell find $(F0_LIB_BASE)/src -name '*.c' -type f -printf "%f\n")
...
STM32F0_PERIPH_SRCS = $(addprefix $(F0_LIB_BASE)/src/,$(F0_PERIPH_SOURCES))
STM32F0_PERIPH_SRCS += $(F0_CMSIS_SOURCES)
